package net.unethicalite.plugins.butler2;
...
@Extension
@Slf4j
@PluginDescriptor(name = "Unethical Butler2", enabledByDefault = false)
public class UnethicalButler2Plugin extends Plugin
{
	@Inject
	private Client client;

	@Inject
	private UnethicalButler2Config config;
	...
	@Provides
	UnethicalButler2Config provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(UnethicalButler2Config.class);
	}
}
